  ...
  <div className={`nav-links ${menuOpen ? "show" : ""}`}>
    ...
    <button className="navbt" onClick={() => navigate("/contactus")}>Contact</button>
            ...
            <div className="succon">
             ...
             <div className="sus"><div className="sushd"><p className="susp">Contact <b>Us</b></p><h1 className="u1">__________</h1><h1 className="u2">__________</h1></div>
             <div className="contacttable">
                <div className="contactitem"><button className="contacticon"><i class="fa fa-map-marker" aria-hidden="true"></i></button><h2>Address </h2><h4>SRI ANGALAMMAN MATRIMONY,</h4><h4>108, ANNA STREET,</h4><h4>SIVAGIRI, ERODE(DT),</h4><h4>TAMILNADU,</h4><h4>PINCODE -638109</h4></div>
                <div className="contactitem"><button className="contacticon"><i class="fa fa-phone" aria-hidden="true"></i></button><h2>Call Us </h2><p>9629891299</p><p>9629891299 ( Whats App )</p></div>
                <div className="contactitem"><button className="contacticon"><i class="fa fa-envelope" aria-hidden="true"></i></button><h2>Email </h2><p>info@sriangalammanmatrimony.com</p></div>

             </div>
                   </div>
            </div>
            <div className="contactinputtable">
                <div className="contactinputitem"><h4>First Name</h4><input className="contactinputbox"></input></div>
                <div className="contactinputitem"><h4>Last Name</h4><input className="contactinputbox"></input></div>
                <div className="contactinputitem"><h4>Subject</h4><input className="contactinputbox"></input></div>
                <div className="contactinputitem"><h4>Email</h4><input className="contactinputbox"></input></div>
                <div className="contactinputitem"><h4>First Name</h4><input className="contactmessagebox"></input></div>
                <div className="contactinputitem"><button className="contactsubmitbtn">Submit</button></div>
            </div>
